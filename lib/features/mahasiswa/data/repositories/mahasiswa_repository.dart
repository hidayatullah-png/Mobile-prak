...
class MahasiswaRepository {
  Future<List<MahasiswaModel>> getAllMahasiswa() async {
    ...
    return [
      MahasiswaModel(nama: 'Caelus', nim: '100526', jurusan: 'Ilmu Komunikasi', email: 'caelus467904@gmail.com', isAktif: true),
      ...
      MahasiswaModel(nama: 'Hidayatullah Sukma Dewi', nim: '100365', jurusan: 'Teknik Informatika', email: 'skopeo365@gmail.com', isAktif: true),
    ];
  }
